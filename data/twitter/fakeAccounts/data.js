...
const data = [
    ...
    },
    {
        ...
        description: "<h2> Fake Twitter Account Promoting Love Jihad</h2><p>Fake Twitter Account Promoting Love Jihad By tweeting, she tweeted that can she marry a muslim boy , her tweet is for get attention and increase followers </p> twitter account <a href='https://twitter.com/mahiRajput_'>@MahiRajput_</a> is a fake account using someone's photo from pinterest and promoting Love Jihad </p> <img src='./media/img/twitter/fakeProfiles/case1/id report.png' height='auto' width='auto' alt='@MahiRajput_ Fake Profile that is promoting Love Jihad' style='margin:30px'> <p>here is a screenshot of that tweet in she asked that she could marry a muslim boy. </p> <p> <img src='./media/img/twitter/fakeProfiles/case1/crime.png' height='auto' width='auto' alt='this fake account's tweet that created controversy'></p><p>this fake account had tweeted same for increase followers in 2021. this account is using someone's pictures in its profile and cover photo. we found that photos on pinterest through help of google lense</p> <p> </p> </div>",
        time: 10,
    },
    {
        index: 2,
